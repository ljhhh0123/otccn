...
main(n, t)
{
    ...
    dstk = strcpy(sym_stk = mmap(0x10000000,0x40000,PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0), " int if else while break return for define main ") + TOK_STR_SIZE;
    glo = sym_stk+0x10000;
    ind = prog = sym_stk+0x20000;
    vars = sym_stk+0x30000;
