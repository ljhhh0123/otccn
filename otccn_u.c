...
main(n, t)
{
    ...
    dstk = strcpy(sym_stk = mmap(0x10000000,0x10000,PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0), 
                  " int if else while break return for define main ") + TOK_STR_SIZE;
    glo = mmap(0x10100000,0x10000,PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0);
    ind = prog = mmap(0x10200000,0x10000,PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0);
    vars = mmap(0x10200000,0x10000,PROT_READ | PROT_WRITE | PROT_EXEC, MAP_PRIVATE|MAP_ANON, 0, 0);
